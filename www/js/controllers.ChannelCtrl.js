...
{
  app.controller('ChannelCtrl', ['$scope', '$stateParams', 'UI', 'Api', 'RestRoute', '$ionicFrostedDelegate','$ionicScrollDelegate', '$timeout', 'Restangular', 
    function($scope, $stateParams, UI, Api, RestRoute, $ionicFrostedDelegate, $ionicScrollDelegate, $timeout, Restangular) {
